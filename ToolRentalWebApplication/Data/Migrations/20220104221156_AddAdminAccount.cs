...
namespace ToolRentalWebApplication.Data.Migrations
{
    ...
    {
        const string ADMIN_USER_GUID = "e43676a8-e6ee-49ea-8c3e-f31e9bd42354";
        const string ADMIN_ROLE_GUID = "aaa98d9b-a771-4087-bb1e-dea4589a2bb9";
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            sb.AppendLine(",'volkovui@gmail.com'");
            sb.AppendLine(",'VOLKOVUI@GMAIL.COM'");
            sb.AppendLine(",'volkovui@gmail.com'");
            sb.AppendLine(", 0");
            sb.AppendLine(", 0");
